...
bool isValidNumber(int& quantity);
...
public:
    ...
    void viewCart(vector<Order>& orders) {
        ...
        string checkoutChoice = getValidYesNoInput("Do you want to check out all the products? (Y/N): ");
    ...
    while (true) {
        ...
        if (choice == 1) {
            ...
            do {
                ...
                addMore = getValidYesNoInput("Do you want to add another product? (Y/N): ");
